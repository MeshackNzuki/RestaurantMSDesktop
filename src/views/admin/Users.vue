<template>
    <div>
        <Table :headers="[
            ...
            'STAFF NUMBER',
            'ACTIONS',
        ]" title="User Management" search_placeholder="Search User" :rows="userData?.length">
            <template v-slot:actions>
                <SmallButton icon="pi pi-plus" buttonText='Add New' :action="() => showModal('addUser')">
                </SmallButton>
            </template>
        ...
        <dialog id="addUser" class="modal modal-bottom sm:modal-middle">
            ...
            <div class="modal-box dark:text-slate-400 dark:bg-sky-950">
                ...
                <div class="modal-action flex justify-center">
                    <form @submit.prevent="addUser" class="flex-1 flex-col justify-center gap-2">
                        <div>
                            <label for="name" class="block text-smtext-left">name</label>
                            <input v-model="newUser.name" type="text" id="name" name="name" required
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-slate-500 focus:border-slate-500 sm:text-sm"
                                placeholder="Enter name" />
                        </div>
                        <div>
                            <label for="edit_name" class="block text-smtext-left">Email</label>
                            <input v-model="newUser.email" type="text" id="edit_email" name="edit_email" required
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-slate-500 focus:border-slate-500 sm:text-sm"
                                placeholder="Enter Email" />
                        </div>
                        <div>
                            <label for="details" class="block text-smtext-left">Details</label>
                            <input v-model="newUser.details" type="text" id="details" name="details" required
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-slate-500 focus:border-slate-500 sm:text-sm"
                                placeholder="Enter user details" />
                        </div>
                        <div>
                            <label for="role" class="block text-sm text-left">Role</label>
                        ...
                        <div>
                            ...
                            <input v-model="newUser.phone" type="tel" id="phone" name="phone" required
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-slate-500 focus:border-slate-500 sm:text-sm"
                                placeholder="Enter phone number" />
                        </div>
                        <div>
                            <label for="staff_number" class="block text-smtext-left">Staff Number</label>
                            <input v-model="newUser.staff_number" type="text" id="staff_number" name="staff_number"
                                required
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-slate-500 focus:border-slate-500 sm:text-sm"
                                placeholder="Enter staff number" />
                        </div>
                        <div class="col-span-2 flex justify-end mt-2">
                            <CommonButton button-text="Submit" :action="() => addUser" />
                        </div>
                    </form>
                </div>
            </div>
