<template>
    <div class="bg-slate-100 dark:bg-sky-950 min-h-screen rounded-md">
        <div class="flex flex-wrap justify-around my-6 py-12 w-full gap-4">
            ...
            <StatCard label="Loss" quantity="97" icon="pi pi-exclamation-circle" description="All Combined" />
            <StatCard label="Expenses" description="Total this year" icon="pi pi-arrow-right-arrow-left"
                quantity="KES 300,000" />
        </div>
        <div class="flex mt-4">
                ...
                <div class="w-full flex flex-col justify-center items-center h-[30vh]">
                    <div class="flex flex-col gap-4 mb-4">
                        <div class="flex flex-row gap-4">
                            <SmallStatCard icon="pi pi-user-plus" label="Waiters" quantity="67" />

                            <SmallStatCard icon="pi pi-user-plus" label="Chefs" quantity="7" />
                        </div>
                        <div class="flex flex-row gap-4">
                            <SmallStatCard icon="pi pi-graduation-cap" label="Oficials" quantity="567" />
                            <SmallStatCard icon="pi pi-user" label="Customers" quantity="3000" />
                        </div>
                    </div>
